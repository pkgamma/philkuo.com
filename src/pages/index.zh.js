...
export default function Home() {
  ...
  return (
    <Layout>
      ...
      <p>曾於美國 <a target="_blank" rel="noreferrer" href="https://www.cat.com/zh_TW/company.html">Caterpillar 卡特彼勒</a>的數位部門擔任軟體工程師，亦於 <a target="_blank" rel="noreferrer" href="https://www.deepwalkresearch.com/">DeepWalk Research</a> 擔任產品企劃，及於 <a target="_blank" rel="noreferrer" href="http://philkuo.com/c">Hack4Impact</a> 與 <a target="_blank" rel="noreferrer" href="https://menuthree.com">Menu3</a> 擔任產品設計工程師。現在，我盡心投入運行 <a target="_blank" rel="noreferrer" href="http://pkgamma.com">PKGamma 數位機構</a>，與我的客戶密切合作，開發成效出色的數位解決方案。</p>
